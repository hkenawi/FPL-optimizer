...
def consolidate_player_offensive_data() -> pd.DataFrame:
    """
    ...
    for season in seasons:
        temp_df = pd.read_csv(filepath_or_buffer=f'./raw data/{season}_player_offensive_stats.csv',
                              header=1)
...
if __name__ == "__main__":
    stacked_offensive_player_df = consolidate_player_offensive_data()
